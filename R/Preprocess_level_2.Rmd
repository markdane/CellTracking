...
#                        "Palbociclib_25", "Palbociclib_50", "Palbociclib_100",  "Palbociclib_250" , "Palbociclib_500",
#                        "Palbociclib_1000", "Palbociclib_2500", "Palbociclib_5000",
#                        
...
#                        
#                         "Trametinib_1", "Trametinib_5", "Trametinib_25","Trametinib_50", "Trametinib_100", "Trametinib_250",
#                        "Trametinib_500", "Trametinib_1000", "Trametinib_2500", "Trametinib_5000",
#                        
...
#                        "Gemcitabine_0.25", "Gemcitabine_0.5", "Gemcitabine_1", "Gemcitabine_1.5","Gemcitabine_2", "Gemcitabine_2.5","Gemcitabine_3"
#   )
#   
...
generate_l2_plots <- function(plateID){
  ...
  #treatments_colors <-  rep(c("cornflowerblue", "darkcyan", "cadetblue4", "cadetblue", "blue", "blue3", "darkblue"), length.out = length(treatments))  
  ...
  # p_n_t <- ggplot(df, aes(x = elapsed_minutes, y = n, color = treatment, group = interaction(field, well))) +
  #   geom_path() +
  #   stat_summary(fun=mean, aes(group=1), geom="line", colour="blue") +
  #   scale_y_continuous(trans = 'log2') +
  ...
  # p_n_t_T0 <- ggplot(df, aes(x = elapsed_minutes, y = cell_count_norm_T0, color = treatment, group = interaction(field, well))) +
  #   geom_path() +
  #   stat_summary(fun=mean, aes(group=1), geom="line", colour="blue") +
  #   scale_y_continuous(trans = 'log2') +
  ...
  # p_CC_t <- ggplot(df, aes(x = elapsed_minutes, y = Nuclei_CKn_CC_mean_intensity, color = treatment, group = interaction(field, well))) +
  #   geom_path() +
  #   stat_summary(fun=mean, aes(group=1), geom="line", colour="blue") +
  #   labs(title = "Cell cycle intensity in the nuclei, mean",
  #        xlab = "minutes",
  ...
  # p_cyto_CC_t <- ggplot(df, aes(x = elapsed_minutes, y = Cyto_CKn_CC_mean_intensity, color = treatment, group = interaction(field, well))) +
  #   geom_path() +
  #   stat_summary(fun=mean, aes(group=1), geom="line", colour="blue") +
  #   labs(title = "Cell cycle intensity in the cytoplasm, mean",
  #        xlab = "minutes",
  ...
  # p_cyto_CC_t_ratio <- ggplot(df, aes(x = elapsed_minutes, y = Cell_CKn_CC_mean_intensity_ratio, color = treatment, group = interaction(field, well))) +
  #   geom_path() +
  #   stat_summary(fun=mean, aes(group=1), geom="line", colour="blue") +
  #   labs(title = "Cell cycle intensity in the cytoplasm/nuclei, mean",
  #        xlab = "minutes",
