...
p_cell_count_dose_response <- ggplot(df_mean_select_0, aes(x = Drug1ConcentrationRank, y = cell_count_norm_control, color = hours, group = hours)) +
  ...
  pdf(paste0(data_path,"HCC1143_summary_",pipeline_name,".pdf"), width = 10, height = 4)
  print(p_n_t_T0_mean)
  print(p_G1_t_mean)
...
get_level_2_data <- function(plateID, data_path = "/home/exacloud/gscratch/HeiserLab/images/", pipeline_name = "CtnK"){
