  ...
  level_2_data_path <- paste0(data_path,plateID,"/Analysis/",pipeline_name,"/",plateID,"_level_2.csv")
    ...
    treatment_levels = c("vehicle",
                       ...
                       "JQ1_50",  "JQ1_100", "JQ1_250", "JQ1_500", "JQ1_1000", "JQ1_2500", "JQ1_5000",
                        "Bortezomib_1",  "Bortezomib_2.5", "Bortezomib_5", "Bortezomib_10", "Bortezomib_20", "Bortezomib_30", 
                       "Bortezomib_50",  "Bortezomib_100", "Bortezomib_250", "Bortezomib_500", "Bortezomib_1000", "Bortezomib_2500", "Bortezomib_5000",
  ...
  if(!file.exists(level_1_data_path)){
    ...
    l1 <- map(dir(paste0(data_path,plateID,"/Analysis/",pipeline_name,"/"),pattern = paste0(plateID,"_.*_level_1.csv"), full.names = TRUE), read_csv,
      ...
      mutate(day = str_remove(time_slice, "d.*"),
             ...
             cell_cycle_state = case_when(Cell_PI_CC_mean_intensity_ratio <= 1 ~"G1",
                                          Cell_PI_CC_mean_intensity_ratio > 1 ~"S/G2")) %>%
    ...
    l2 <- l1 %>%
      ...
      summarise(n = n(),
                ...
                G1_proportion = table(cell_cycle_state)[1]/n,
                .groups = "drop")
...
generate_plots <- function(plateID, l1, l2){
  cols <- c("BEZ235_1" = "cornflowerblue", "Cabozantinib_50" = "cornflowerblue", "Trametinib_50" = "cornflowerblue",
           ...
           "MG132_20" = "blue", "MG132_30" = "blue3", "MG132_50" = "darkblue", 
             "Everolimus_50" = "cornflowerblue", "Everolimus_100"= "darkcyan", "Everolimus_250" = "cadetblue4", "Everolimus_500" = "cadetblue",
            "Everolimus_1000" = "blue", "Everolimus_2500" = "blue3", "Everolimus_5000" = "darkblue")
...
#res <- map(c("AU01401", "AU01502", "AU01601","AU01602", "AU01701", "AU01702"), process_plate)
res <- map(c(  "AU01901"), process_plate)
plateID <- "AU01901"
```
