...
create_level_2_data <- function(plateID, data_path = "/home/exacloud/gscratch/HeiserLab/images/", pipeline_name = "CKn"){
  ...
  if(!file.exists(l1_data_path)){
    ...
    l1_data <- map_dfr(dir(paste0(data_path,plateID,"/Analysis/",pipeline_name),pattern = paste0(plateID,"_.*_level_1.csv"), full.names = TRUE)[1:2], read_csv,
              col_types =cols(.default = "c",
                              Nuclei_CKn_CC_mean_intensity = col_double(),
...
>>>>>>> 6195f4ccffba360cea9f0dc14adb77ff081fb5fa:R/data_preview.Rmd
...
print(paste("average track lengths are: ", mean_track_length))
# %>%
