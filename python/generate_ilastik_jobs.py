...
for file_path in file_paths:
    ...
    if not os.path.exists(mask_file_path):
        cmd = "srun -c 4 --job-name=i"+plateID[3:8]+well+field+" -o i"+plateID[3:8]+well+field+"_out.txt /home/users/dane/ilastik-1.4.0b15-Linux/run_ilastik.sh --headless --readonly=True --input_axes=tyxc --project=/home/groups/heiserlab_genomics/home/dane/CellTracking/AU565/AU00901_Pixel_112920_TRAINING.ilp --raw_data="+file_path+" --export_source='Simple Segmentation' --output_format='hdf5' --output_filename_format="+output_path+"/{nickname}_{result_type} &"
